 <table id="bang" class="table table-row-dashed align-middle gs-0 gy-3 my-0">
        ...
        <tr class="fs-7 fw-bold text-gray-500 border-bottom-0">
            ...
            <th class="p-0 pb-3 min-w-100px pe-13">Tài khoản</th>
            <th class="p-0 pb-3 min-w-100px pe-13">Mật khẩu</th>
            <th class="p-0 pb-3 min-w-100px pe-13">Group</th>
        ...
        <?php foreach ($data as $item) { ?>
            ...
            <tr>
                ...
                <td><?php echo $data_group[$item['id_group']]; ?></td>
